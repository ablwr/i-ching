...
"111111": {"definition": "01. Force (乾 qián); The Creative; Possessing Creative Power & Skill",
            "hexagram": " ䷀ ",
            "number": "1",
            "description": "Sheaven above and Sheaven below: Sheaven in constant motion. With the strength of the dragon, the Superior Person steels herself for ceaseless activity. Productive activity. Potent Influence. Sublime success if you keep to your course."},
  ...
  "111010": {"definition": "05. Attending (需 xū); Waiting; Uninvolvement (Wait for now), Nourishment ",
            "hexagram": " ䷄ ",
            "number": "5",
            "description": "Deep Waters in the Sheavens: Thunderclouds approaching from the west, but no rain yet. The Superior Person nourishes herself and remains of good cheer to condition herself for the moment of truth. Great success if you sincerely keep to your course. You may cross to the far shore."},
  "010111": {"definition": "06. Arguing (訟 sòng); Conflict; Engagement in Conflict ",
            "hexagram": " ䷅ ",
            "number": "6",
            "description": "The high Sheavens over a yawning Deep chasm: an expansive void where nothing can dwell. Even though she sincerely knows she is right, the Superior Person anticipates opposition and carefully prepares for any incident. Good fortune if your conflict results in compromise. Misfortune if your conflict escalates to confrontation. Seek advice. Postpone your crossing to the far shore."},
  ...
  "111011": {"definition": "09. Small Accumulating (小畜 xiǎo chù); Small Taming; Accumulating Resources",
            "hexagram": " ䷈ ",
            "number": "9",
            "description": "Winds of change high in the Sheavens: Air currents carry the weather. Dense clouds blow in from the west, but still no rain. The Superior Person fine tunes the image she presents to the world. Small successes."},
  "110111": {"definition": "10. Treading (履 lǚ); Treading (Conduct); Continuing with Alertness",
            "hexagram": " ䷉ ",
            "number": "10",
            "description": "Sheaven shines down on the Marsh which reflects it back imperfectly: Though the Superior Person carefully discriminates between high and low, and acts in accord with the flow of the Tao, there are still situations where a risk must be taken. You tread upon the tail of the tiger. Not perceiving you as a threat, the startled tiger does not bite. Success."},
  "111000": {"definition": "11. Pervading (泰 tài); Peace; Pervading",
            "hexagram": " ䷊ ",
            "number": "11",
            "description": "Sheaven and Earth embrace, giving birth to Peace. The Superior Person serves as midwife, presenting the newborn gift to the people. The small depart; the great approach. Success. Good fortune."},
  "000111": {"definition": "12. Obstruction (否 pǐ); Standstill; Stagnation",
            "hexagram": " ䷋ ",
            "number": "12",
            "description": "Sheaven and Earth move away from each other. In the ensuing void, the small invade where the great have departed. There is no common meeting ground, so the Superior Person must fall back on her inner worth and decline the rewards offered by the inferior invaders. Difficult trials as you hold to your course."},
  "101111": {"definition": "13. Concording People (同人 tóng rén); Fellowship; Fellowship, Partnership",
            "hexagram": " ䷌ ",
            "number": "13",
            "description": "Sheaven reflects the Flame of clarity: The Superior Person analyzes the various levels and working parts of the social structure, and uses them to advantage. Success if you keep to your course. You may cross to the far shore."},
  "111101": {"definition": "14. Great Possessing (大有 dà yǒu); Great Possession; Independence, Freedom",
            "hexagram": " ䷍ ",
            "number": "14",
            "description": "The Fire of clarity illuminates the Sheavens to those below: The Superior Person possesses great inner treasures -- compassion, economy, and modesty. These treasures allow the benevolent will of Sheaven to flow through her outward to curb evil and further good. Supreme success."},
  ...
  "100111": {"definition": "25. Without Embroiling (無妄 wú wàng); Innocence; Without Rashness",
            "hexagram": " ䷘ ",
            "number": "25",
            "description": "Thunder rolls beneath Sheaven, as is its nature and place: Sage rulers aligned themselves with the changing seasons, nurturing and guiding their subjects to do the same. Exceptional progress if you are mindful to keep out of the way of the natural Flow. It would be a fatal error to try to alter its course. This is a time of Being, not Doing."},
  "111001": {"definition": "26. Great Accumulating (大畜 dà chù); Great Taming; Accumulating Wisdom",
            "hexagram": " ䷙ ",
            "number": "26",
            "description": "Sheaven's motherlode waits within the Mountain: The Superior Person mines deep into history's wealth of wisdom and deeds, charging her character with timeless strength. Persevere. Drawing sustenance from these sources creates good fortune. Then you may cross to the far shore."},
  ...
  "001111": {"definition": "33. Retiring (遯 dùn); Retreat; Withdrawing",
            "hexagram": " ䷠ ",
            "number": "33",
            "description": "The tranquil Mountain towers overhead, yet remains this side of Sheaven: The Superior Person avoids the petty and superficial by keeping shallow men at a distance, not in anger but with dignity. Such a retreat sweeps the path clear to Success. Occupy yourself with minute detail."},
  "111100": {"definition": "34. Great Invigorating (大壯 dà zhuàng); Great Power; Great Boldness",
            "hexagram": " ䷡ ",
            "number": "34",
            "description": "Thunder fills the Sheavens with its awful roar, not out of pride, but with integrity; if it did less, it would not be Thunder: Because of her Great Power, the Superior Person takes pains not to overstep her position, so that she will not seem intimidating or threatening to the Established Order. Opportunity will arise along this course."},
  ...
  "101011": {"definition": "37. Dwelling People (家人 jiā rén); The Family; Family",
            "hexagram": " ䷤ ",
            "number": "37",
            "description": "Warming Air Currents rise and spread from the Shearthfire: The Superior Person weighs her words carefully and is consistent in her behavior. Be as faithful as a good wife."},
  ...
  "111110": {"definition": "43. Parting (夬 guài); Breakthrough; Separation",
            "hexagram": " ䷪ ",
            "number": "43",
            "description": "A Deluge from Sheaven: The Superior Person rains fortune upon those in need, then moves on with no thought of the good she does. The issue must be raised before an impartial authority. Be sincere and earnest, despite the danger. Do not try to force the outcome, but seek support where needed. Set a clear goal."},
  "011111": {"definition": "44. Coupling (姤 gòu); Coming to Meet; Encountering",
            "hexagram": " ䷫ ",
            "number": "44",
            "description": "A playful Zephyr dances and delights beneath indulgent Sheaven: A Prince who shouts orders but will not walk among her people may as well try to command the four winds. A strong, addictive temptation, much more dangerous than it seems."},
