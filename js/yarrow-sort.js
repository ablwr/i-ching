var Stalks = 50;
var HandPile, EastPile, WestPile;
var EastRemainder, WestRemainder;
var CountValue1, CountValue2, CountValue3;
var LineValue;
...
var DrawLine = function(line,changing){
  if (changing && line == 'weak')    ResultingLine = 'o';
  if (changing && line == 'strong')  ResultingLine = 'x';
  if (!changing && line == 'strong') ResultingLine = '1';
  if (!changing && line == 'weak')   ResultingLine = '0';
}
